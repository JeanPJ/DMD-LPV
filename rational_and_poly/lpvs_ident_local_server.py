...
for rank in rank_list:
    ...
    for pr_rank in pr_rank_list:
        ...
        diffusion_black_box_model.local_train_alt(T_plot_init_list,u_signal_list,p_list,T_plot_list,pod_rank = rank,proc_rank = pr_rank,reg_par =reg_par, reg_lti = reg_lti)
...
save_dict = {'T_sim':T_sim}

io.savemat("test_simulation.mat",save_dict)
