...
class BlackBoxLPVS:
    ...
    def local_train(self,X_list,U_list,p_list,Y_list,reg_par = 0,reg_lti = 0,pod_rank = 0,proc_rank = 0):
        ...
        for i,p in enumerate(p_list.T):
            ...
            e = dummy_LTI.train(X_list[i], U_list[i], Y_list[i],reg = reg_lti)
        ...
        s_reverse_A = s_A/(s_A**2 + reg_par**2)
        ...
        s_reverse_B = s_B/(s_B**2 + reg_par**2)
    ...
    def local_train_alt(self,X_list,U_list,p_list,Y_list,reg_par = 0,reg_lti = 0,pod_rank = 0,proc_rank = 0):
        ...
        for i,p in enumerate(p_list.T):
            ...
            e = dummy_LTI.train(self.T.T@X_list[i], U_list[i], self.T.T@Y_list[i],reg = reg_lti)
